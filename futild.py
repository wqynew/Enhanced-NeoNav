...
#worlds= ['Home_001_2','Home_003_2','Home_004_2','Home_014_2']

#worlds= ['Home_001_1','Home_003_1','Home_004_1','Home_006_1']
...
#    
    def __getitem__(self, index):
        ...
        return (torch.from_numpy(self.depth_data[world][imid].transpose(2, 0, 1)).float(),
                self.strname[index])
